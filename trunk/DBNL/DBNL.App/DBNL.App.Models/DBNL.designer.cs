...
namespace DBNL.App.Models
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="hostpro_dubao")]
    ...
    partial void OnBannerPositionChanged();
		...
		[Column(Storage="_Url", DbType="NVarChar(150) NOT NULL", CanBeNull=false)]
		public string Url
		{
			get
			{
		...
		[Column(Storage="_BannerImage", DbType="NVarChar(150) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Status", DbType="NChar(50) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="ausp_dubao.Contacts")]
	...
	[Table(Name="ausp_dubao.ContentCategories")]
    ...
    partial void OnParentCategoryIdChanged();
		...
		[Column(Name="[Key]", Storage="_Key", DbType="NVarChar(150) NOT NULL", CanBeNull=false)]
		public string Key
		{
			get
			{
		...
		[Association(Name="ContentCategory_ContentCategory", Storage="_ContentCategories", OtherKey="ParentCategoryId")]
		...
		[Association(Name="ContentCategory_Content", Storage="_Contents", OtherKey="CategoryId")]
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Name="Content", Storage="_Content1", DbType="NText", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsFeatured", DbType="Bit")]
		...
		[Column(Storage="_UniqueKey", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
    ...
    partial void OnUpdatedDateChanged();
		...
		[Column(Storage="_Url", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
		public string Url
		{
			get
			{
	...
	[Table(Name="ausp_dubao.PollQuestions")]
    ...
    partial void OnResponsesChanged();
		...
		[Column(Storage="_Question", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Responses", DbType="Int NOT NULL")]
		...
		[Association(Name="Poll_PollQuestion", Storage="_Poll", ThisKey="PollId", IsForeignKey=true)]
		public Poll Poll
		{
			get
			{
    ...
    partial void OnStatusChanged();
		...
		[Column(Storage="_PollName", DbType="NVarChar(250) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Poll_PollQuestion", Storage="_PollQuestions", OtherKey="PollId")]
    ...
    partial void OnComponentPermissionChanged();
		...
		[Column(Storage="_ContentPermission", DbType="NVarChar(250)")]
	...
	[Table(Name="ausp_dubao.Supporters")]
    ...
    partial void OnStatusChanged();
		...
		[Column(Storage="_Nickname", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
	...
	[Table(Name="ausp_dubao.UserInRoles")]
	...
	[Table(Name="ausp_dubao.Navigations")]
    ...
    partial void OnAreaChanged();
		...
		[Column(Storage="_Possition", DbType="NVarChar(50)")]
		...
		[Column(Storage="_RelativeUrl", DbType="NVarChar(50)")]
		...
		[Column(Storage="_Image", DbType="NVarChar(150)")]
		public string Image
		{
			get
			{
		...
		[Column(Storage="_Action", DbType="NVarChar(100)")]
		...
		[Column(Storage="_Controller", DbType="NVarChar(100)")]
		...
		[Column(Storage="_Area", DbType="NVarChar(100)")]
		public string Area
		{
			get
			{
		...
		[Association(Name="Navigation_Navigation", Storage="_Navigation1", ThisKey="ParentId", IsForeignKey=true)]
